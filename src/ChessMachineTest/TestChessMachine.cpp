...
BOOST_AUTO_TEST_CASE(StartTest) {
    ...
    const std::map<Type, TestMoves> white_pieces = {{Type::pawn,
                                                     {{a2, {a4, a3}},
                                                      {b2, {b3, b4}},
                                                      {c2, {c3, c4}},
                                                      {d2, {d4, d3}},
    ...
    const std::map<Type, TestMoves> black_pieces = {{Type::pawn,
                                                     {{a7, {a6, a5}},
                                                      {b7, {b6, b5}},
                                                      {c7, {c6, c5}},
                                                      {d7, {d6, d5}},
    ...
    for (auto m : moves) {
        ...
        if (m == "dxe4") {
            ...
            const std::map<Type, TestMoves> white_pieces = {
                {Type::pawn,
                 {{a2, {a4, a3}}, {b2, {b3, b4}}, {c2, {}}, {d2, {d4, d3}}, {f2, {}}, {g2, {g3, g4}}, {h2, {h3, h4}}}},
...
BOOST_AUTO_TEST_CASE(DebutSubtletyTest) {
    ...
    */
    ...
    const std::vector<std::string> moves = split(
        "1.e4 c6 2.Nc3 d5 3.Nf3 dxe4 4.Nxe4 Bf5 5.Ng3 Bg6 6.h4 h6 7.Ne5 Bh7 8.Qh5 g6 9.Qf3 Nf6 10.Qb3 Qd5 11.Qxb7 "
        "Qxe5+ 12.Be2 Qd6 13.Qxa8 Qc7 14.a4 Bg7 15.Ra3 O-O 16.Rb3");
...
BOOST_AUTO_TEST_CASE(DangerousReidTest) {
    ...
    */
    ...
    const std::vector<std::string> moves = split(
        "1.e4 c6 2.d4 d5 3.exd5 cxd5 4.c4 Nf6 5.Nc3 Nc6 6.Bg5 Qb6 7.cxd5 Qxb2 8.Rc1 Nb4 9.Na4 Qxa2 10.Bc4 Bg4 11.Nf3 "
        "Bxf3 12.gxf3");
...
BOOST_AUTO_TEST_CASE(HaplessQueenTest) {
    ...
    */
    ...
    const std::vector<std::string> moves =
        split("1.e4 d5 2.exd5 Qxd5 3.Nc3 Qa5 4.d4 Nf6 5.Bd2 Nc6 6.Bb5 Bd7 7.Nd5 Qxb5 8.Nxc7+ Kd8 9.Nxb5");
    ...
    for (auto m : moves) {
        ...
        if (m == "Bd7") {
            ...
            BOOST_CHECK(machine->CheckStatus() == Status::normal);
            {
                const std::map<Type, TestMoves> black_pieces = {
                    {Type::pawn,
                     {{a7, {a6}}, {b7, {b6}}, {c7, {}}, {e7, {e6, e5}}, {f7, {}}, {g7, {g5, g6}}, {h7, {h5, h6}}}},
...
BOOST_AUTO_TEST_CASE(HorseBetterQueenTest) {
    ...
    */
    ...
    const std::vector<std::string> moves =
        split("1.d4 d5 2.c4 e5 3.dxe5 d4 4.e3 Bb4+ 5.Bd2 dxe3 6.Bxb4 exf2+ 7.Ke2 fxg1=N+ 8.Rxg1 Bg4+");
    ...
    for (auto m : moves) {
        ...
        if (m == "fxg1=N") {
            ...
            const std::map<Type, TestMoves> black_pieces = {
                {Type::pawn,
                 {{a7, {a6, a5}}, {b7, {b6, b5}}, {c7, {c6, c5}}, {f7, {f6, f5}}, {g7, {g5, g6}}, {h7, {h5, h6}}}},
...
Kc7 57.Ke4 Kc6 58.Ke5 Kc7 59.Qd6+ Kb7 60.Kd5 Kc8 61.Kc6 *");
    ...
    for (auto m : moves) {
        ...
        if (move == 2 && m == "e5") {
            ...
            const std::map<Type, TestMoves> white_pieces = {
                {Type::pawn,
                 {{a2, {}}, {c4, {c5}}, {e4, {e5}}, {g5, {g6, h6 /*en passant*/}}, {g2, {g3, g4}}, {h2, {}}}}};
            testpos(white_pieces, machine->GetSet(Set::white), *machine);
            ...
            const std::map<Type, TestMoves> white_pieces = {
                {Type::pawn,
                 {{a2, {}}, {c4, {c5}}, {e4, {}}, {g5, {g6 /*no more en passant*/}}, {g2, {g3, g4}}, {h2, {h3, h4}}}}};
            testpos(white_pieces, machine->GetSet(Set::white), *machine);
        } else if (nm == 14 * 2 + 1 && m == "Qxd3") {
            BOOST_TEST_MESSAGE(std::to_string(move) + " " + m);
            BOOST_CHECK(machine->CheckStatus() == Status::normal);
            const std::map<Type, TestMoves> white_pieces = {{Type::king, {{e1, {f2 /*impossible castling*/}}}}};
            testpos(white_pieces, machine->GetSet(Set::white), *machine);
        } else if (move == 18 && m == "c5") {
            BOOST_TEST_MESSAGE(std::to_string(move) + " " + m);
            BOOST_CHECK(machine->CheckStatus() == Status::normal);
            const std::map<Type, TestMoves> black_pieces = {{Type::king, {{e8, {e7 /*impossible castling*/}}}}};
            testpos(black_pieces, machine->GetSet(Set::black), *machine);
        } else if (move == 20 && m == "h4") {
            BOOST_TEST_MESSAGE(std::to_string(move) + " " + m);
            BOOST_CHECK(machine->CheckStatus() == Status::normal);
            const std::map<Type, TestMoves> white_pieces = {{Type::king, {{e1, {f2, d2, d1 /*impossible castling*/}}}}};
            testpos(white_pieces, machine->GetSet(Set::white), *machine);
        } else if (move == 23 && m == "Bg4") {
            BOOST_TEST_MESSAGE(std::to_string(move) + " " + m);
            BOOST_CHECK(machine->CheckStatus() == Status::normal);
            const std::map<Type, TestMoves> black_pieces = {{Type::king, {{e8, {e7, f8, g8 /*possible castling*/}}}}};
            testpos(black_pieces, machine->GetSet(Set::black), *machine);
            ...
            BOOST_TEST_MESSAGE(std::to_string(move) + " " + m);
            BOOST_CHECK(machine->CheckStatus() == Status::normal);
            const std::map<Type, TestMoves> black_pieces = {{Type::king, {{e8, {d8 /*impossible castling*/}}}}};
            testpos(black_pieces, machine->GetSet(Set::black), *machine);
            ...
            testpos(white_pieces, machine->GetSet(Set::white), *machine);
            const std::map<Type, TestMoves> black_pieces = {{Type::pawn, {{a4, {}}, {c6, {}}}},
                                                            {Type::knight, {{a6, {}}, {g4, {}}}},
                                                            {Type::bishop, {{h4, {}}}},
                                                            {Type::rook, {{h3, {}}}},
                                                            {Type::queen, {}},
            ...
            BOOST_CHECK(machine->CheckStatus() == Status::check);
            const std::map<Type, TestMoves> white_pieces = {
                {Type::pawn, {{h7, {}}}}, {Type::knight, {{c4, {}}}}, {Type::bishop, {}},
                {Type::rook, {}},         {Type::queen, {}},          {Type::king, {{e2, {d3, e3, f3, d1, f1}}}}};
            testpos(white_pieces, machine->GetSet(Set::white), *machine);
            const std::map<Type, TestMoves> black_pieces = {
            ...
            testpos(white_pieces, machine->GetSet(Set::white), *machine);
            const std::map<Type, TestMoves> black_pieces = {{Type::pawn, {{a4, {a3}}, {b3, {b2}}}},
                                                            {Type::knight, {}},
                                                            {Type::bishop, {{h4, {g5, f6, e7, d8, g3, f2, e1}}}},
            ...
            const std::map<Type, TestMoves> white_pieces = {
                ...
                {Type::rook, {}},
                {Type::queen,
                 {{b2, {a1, c3, d4, e5, f6, g7, h8, a3, c1, b1, b3, b4, b5, b6, b7, b8, a2, c2, d2, e2, f2, g2, h2}}}},
            ...
            const std::map<Type, TestMoves> white_pieces = {
                ...
                {Type::rook, {}},
                {Type::queen,
                 {{d6, {d1, d2, d3, d4, d5, d7, d8, e6, f6, g6, h6, a3, b4, c5, e7, f8, b8, c7, e5, f4, g3, h2}}}},
                {Type::king, {{c6, {b7, c7, d7, b6, b5, c5, d5}}}}};
            testpos(white_pieces, machine->GetSet(Set::white), *machine);
            const std::map<Type, TestMoves> black_pieces = {{Type::pawn, {}},   {Type::knight, {}},
                                                            {Type::bishop, {}}, {Type::rook, {}},
                                                            {Type::queen, {}},  {Type::king, {{c8, {/*stalemate*/}}}}};
            testpos(black_pieces, machine->GetSet(Set::black), *machine);
        }
        nm++;
    }
